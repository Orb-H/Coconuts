...
|**v1.2**<br>(11/22)|<ul type="bullet"><li>이제 공지사항이 앱 실행 시 볼 수 있습니다.</li><li>레이아웃이 미세하게 수정되었습니다.</li><li>현황 사이트에서 특정 시간(자정인듯)에 쿠키를 갱신하는 것을 대비하여 앱이 켜져있을 시 6시간마다 로그인을 다시합니다.</li></ul>|
