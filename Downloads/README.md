...
### 3. 공지사항 보기
   ...
   - <strike>공지의 세부사항이 보이는 곳에서 아마도 댓글을 달 수 있을 것입니다. 댓글 보내는 게 있다고 아무렇게나 쓰고 올렸다간 그대로 올라갈 수도 있고 씹힐 수도 있고 저도 모르겠습니다.</strike>댓글이 다행히도 안 달립니다.
   - Screenshot
...
### 4. 급식 보기
   ...
   - 2018년에는 관리자가 존재하지 않아 2018년에는 자원하는 학생이 없는 이상 이 서비스는 종료됩니다. 김급식 쓰세요.
   - Screenshot
...
### 2. 디자인 변경
   - 기본 색이 마음에 들지 않으면 다른 색 배합을 사용할 수 있게끔 여러 디자인을 준비했습니다.
...
|**v1.3**<br>(12/08)|<ul type="bullet"><li>피드백을 핸드폰 내부의 메일 앱을 이용하여 보낼 수 있도록 우측 상단 메뉴에 넣었습니다.</li><li>공지사항을 우측 상단 메뉴를 통해서 볼 수 있습니다.</li><li>4자를 인터넷으로 빼는 것이 의미가 없게 되었으므로 4자 항목을 삭제했습니다.</li><li>자습 예약 기능이 생겼습니다. 전날 오전 8시 이후~당일 7시 59분까지 1자, 2자, 3자를 선택하고 예약을 해두면 오전 8시에 일괄적으로 처리됩니다. 이는 푸시 알림 항목으로 보이며 이를 클릭하면 예약이 취소됩니다.</li></ul>|
|**v1.3.1**<br>(12/11)|<ul type="bullet"><li>자습 예약 기능의 오류를 몇 번의 테스트를 통해 수정했습니다.</li></ul>|
...
## Download
<a href="http://raw.githubusercontent.com/Orb-H/Coconuts/master/Downloads/Coconuts%20MOBILE%20v1.3.1.apk">Coconuts MOBILE v1.3.1 다운</a>(바로 다운로드 됩니다. 크기는 약 20MB입니다.)
